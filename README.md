...
- Ensure the bug was not already reported by searching on GitHub
  under [Issues](https://github.com/Qrtix769/Results/issues).
- If you're unable to find an open issue addressing the
  problem, [open a new one](https://github.com/Qrtix769/Results/issues/new). Be sure to include a title and clear
...
- First suggest your change in the [Results ideas page](https://github.com/Qrtix769/Results/discussions/categories/ideas)
  for discussion.
